...
def define_mission_analysis(conditions):
    ...
    plus_3g_sizing_condition(conditions['plus_3g_sizing_condition'])
    
    hover_oei_condition(conditions['hover_oei'])





def plus_3g_sizing_condition(condition):
