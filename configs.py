...
def define_configurations(caddee):
    ...
    caddee.configurations['hover'] = define_hover_configuration(lpc_base_config.copy())


    caddee.configurations.copy(from='base', name='hover')
...
def define_conditions(caddee):
    ...
    hover_condition.vehicle_states = cd.condition_parameterization.HoverParameterizationModel().evaluate()
    ...
    cruise_condition.vehicle_states = cd.condition_parameterization.CruiseParameterizationModel(cruise_condition.states).evaluate()
